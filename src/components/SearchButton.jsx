  ...
  return (
    <div className='flex items-center justify-between border border-gray-500 rounded-full overflow-hidden'>
        ...
        <form className='flex items-center justify-center' onSubmit={handleSumbit}>
            <input id='search' ref={focusSearch} name='search' value={search.search} onChange={handleChange} placeholder='search' className='placeholder:capitalize bg-transparent pl-4 border-none outline-none'>
        ...
        <div className='border-l border-gray-400 h-full py-2 px-5 bg-transparent cursor-pointer hover:bg-cyan-600 transition-all duration-200 ease-in-out hover:text-gray-50'>
