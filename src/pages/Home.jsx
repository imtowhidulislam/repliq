        ...
        <div className='bg-[#b0a8f8] py-12'>
          <header className='container grid grid-cols-homepageLayoutHero1 place-items-center gap-12 md:gap-16 lg:gap-20'>
            <div>
              ...
              <p className='text-sm sm:text-base md:text-base text-[#fff] py-4 text-left'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores eaque eligendi animi accusamus voluptatibus cupiditate consequuntur doloribus repudiandae adipisci temporibus?</p>
              <p className='text-sm sm:text-base md:text-base text-[#ffffff] pb-4 text-left'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit, voluptatem!</p>
              <div className=''>
                <li className=' flex justify-start w-max bg-green-500 text-gray-100 font-bold cursor-pointer py-3 px-8 rounded-full'>
                  <Link to="/product">
                    <button className='capitalize'>shpo now</button>
                  </Link>
                </li>
              </div>
            </div>
